...
- Python >=3.10
- Linux / Windows
- Download from [here](https://github.com/SET-IITGN/TracerSET/releases/download/v1.1.6/tracerset-1.1.6-py3-none-any.whl), and Install using ```pip3 install tracerset-1.1.6-py3-none-any.whl```
- Uninstall using ```pip3 uninstall tracerset-1.1.6-py3-none-any.whl```
